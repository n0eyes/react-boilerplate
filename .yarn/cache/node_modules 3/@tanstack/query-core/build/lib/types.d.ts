...
export declare type PlaceholderDataFunction<TResult> = () =>
  | TResult
  | undefined;
export declare type QueryKeyHashFunction<TQueryKey extends QueryKey> = (
  queryKey: TQueryKey
) => string;
export declare type GetPreviousPageParamFunction<TQueryFnData = unknown> = (
  firstPage: TQueryFnData,
  allPages: TQueryFnData[]
) => unknown;
export declare type GetNextPageParamFunction<TQueryFnData = unknown> = (
...
export declare type UseErrorBoundary<
  TQueryFnData,
  TError,
  TQueryData,
...
export declare type WithRequired<T, K extends keyof T> = Omit<T, K> &
  Required<Pick<T, K>>;
export declare type DefaultedQueryObserverOptions<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
  TQueryData = TQueryFnData,
...
> extends QueryObserverOptions<
    ...
    TQueryKey
  > {}
export declare type DefaultedInfiniteQueryObserverOptions<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
  TQueryData = TQueryFnData,
...
export declare type DefinedQueryObserverResult<
  TData = unknown,
  TError = unknown
> =
...
export declare type InfiniteQueryObserverResult<
  TData = unknown,
  TError = unknown
> =
...
export declare type MutationFunction<TData = unknown, TVariables = unknown> = (
...
export declare type MutationObserverResult<
  TData = unknown,
  TError = unknown,
  TVariables = void,
  TContext = unknown
...
export declare type NotifyEventType =
  | "added"
  | "removed"
  | "updated"
  | "observerAdded"
