...
export declare type RetryValue<TError> =
  | boolean
  | number
  | ShouldRetryFunction<TError>;
declare type ShouldRetryFunction<TError> = (
  failureCount: number,
  error: TError
) => boolean;
export declare type RetryDelayValue<TError> =
  | number
  | RetryDelayFunction<TError>;
declare type RetryDelayFunction<TError = unknown> = (
  failureCount: number,
  error: TError
) => number;
...
export declare function createRetryer<TData = unknown, TError = unknown>(
